...
CALL STORE_VECTOR   ; To be implemented
CALL SORT
NEW_LINE
CALL PRINT_VECTOR
; your code ends here
...
; Read the whole vector from the keyboard using the subroutine 0AH
; Entries are separated by "," (e.g. 18,2,9,7,13,1)
RET
READ_VECTOR ENDP

STORE_VECTOR PROC NEAR
; Store entries from buffer to vector variable
RET
STORE_VECTOR ENDP
